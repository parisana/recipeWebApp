...
public class RecipeToRecipeCommandTest {
    ...
    public static String CAT_ID_1= "1";
    public static String CAT_ID_2="2";
    public static String INGRED_ID_1="3";
    public static String INGRED_ID_2="4";
    public static String NOTES_ID= "9";
