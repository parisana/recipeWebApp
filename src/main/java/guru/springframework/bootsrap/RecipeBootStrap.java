    ...
    private List<Recipe> getRecipes(){
        ...
        tacoNotes.setRecipeNotes(
                "We have a family motto and it is this: Everything goes better in a tortilla.\n" +
                        ...
                        "Read more: http://www.simplyrecipes.com/recipes/spicy_grilled_chicken_tacos/#ixzz50Be1vfXT\n"
            );

        tacosRecipe.setNotes(tacoNotes);
        tacoNotes.setRecipe(tacosRecipe);

        tacosRecipe.setUrl("http://www.simplyrecipes.com/recipes/chicken_tacos");
        ...
        tacosRecipe.addIngredient(new Ingredient("finely grated orange zester", new BigDecimal(1), tableSpoonUom));
